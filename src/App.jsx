...
function App() {
   ...
   const projects = [
      ...
      },
      {
         ...
         description:
            "Branding and website development for a company specializing in karaoke equipment and services.",
         link: "https://vismayintlcorp.com",
      },
      {
         name: "Platinum Karaoke Qatar",
         description:
            "E-commerce website in Qatar for a leading karaoke equipment supplier, featuring a modern design and enhanced user experience.",
   ...
   return (
      <main className="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col items-center transition-colors duration-300">
         ...
         {/* Header Logos */}
         <div className="flex space-x-6 mb-8"></div>
         ...
         <p className="text-gray-600 dark:text-gray-300 mb-12 text-center max-w-2xl">
            Welcome! Here are some of my projects built with Shopify Liquid,
            Javascript and CSS.
         </p>
